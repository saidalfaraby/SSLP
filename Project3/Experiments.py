...
def experiment_w2vKLIEP(type_d, type_pooling='max_p'):
    ...
    predictions[np.where(w > 1.5)[0]] = 1   # w = p_te/p_tr
...
def experiment_tfidfSVM(type_d, topics=100):
    if type_d is 'legal':
        domain = 'legal.half.en'
        domain_out = 'out.mixed.legal.en'
    elif type_d is 'software':
...
def experiment_tfidfKLIEP(type_d, topics=100):
    if type_d is 'legal':
        domain = 'legal.half.en'
        domain_out = 'out.mixed.legal.en'
    elif type_d is 'software':
...
if __name__ == '__main__':
    ...
    # experiment_w2vSVM('software', type_pooling='average_p')

    # experiment_w2vKLIEP('legal', type_pooling='average_p')
    # experiment_w2vKLIEP('software', type_pooling='average_p')
